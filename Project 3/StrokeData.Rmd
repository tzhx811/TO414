...
## Stacked Model
```{r}
stackedmodel = data.frame(decision_tree = stroke_dt_pred, ann = predicted_stroke, knn = stroke_knn_test_pred, logistic_reg = LogReg_Pred, svm = svm_pred, Stroke = general_norm[[2]]$stroke)
